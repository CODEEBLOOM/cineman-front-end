...
const comparePromotions = (left, right) => {
  ...
  const rightStartDate = right?.startDate ? new Date(right.startDate).getTime() : 0;
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        renderCell: (params) => (
          <div className="py-2">
            <p className="font-semibold text-slate-800">{params.value || 'Chưa có tên'}</p>
      ...
      },
      {
        ...
        headerName: 'Số lượng',
        width: 130,
        renderCell: (params) => `${numberFormatter.format(Number(params.value) || 0)} mã`,
      },
      {
        field: 'limitAmount',
        ...
        <div className="mb-4 flex flex-col gap-4 border-b pb-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Theo dõi voucher giảm giá, thời gian áp dụng, số lượng phát hành và trạng
              thái kích hoạt cho từng chương trình.
            </p>
          </div>
